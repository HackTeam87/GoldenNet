...
<div class="header-top">
    <div class="container">
        <div class="w3layouts-address">
            <ul>
                <li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">mail@goldennet.com</a></li>
                <li><i class="fa fa-mobile" aria-hidden="true"></i> +38093 222 33 44</li>
                <li><i class="fa fa-mobile" aria-hidden="true"></i> +38098 222 33 44</li>
                <li><i class="fa fa-mobile" aria-hidden="true"></i> +38095 222 33 44</li>
            </ul>
        </div>
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/contact" class="hvr-sweep-to-bottom">Контакти</a></li>
                    </ul>
                </nav>
            </div>
            <!-- /.navbar-collapse -->
